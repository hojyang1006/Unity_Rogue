...
public class GameManager : SingletonMonobehaviour<GameManager>
{
    ...
    [Tooltip("Populate with the starting dungeon level for tsting , first level =0")]
    ...
    {
        // 던전을 클리어 하면 초기화, 단 각 방을 테스트
        bool isDungeonClearOfRegularEnemies = true;
        bossRoom = null;

        // 모든 던전을 순환하여 적이 제거되었는지 확인
